...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 315.4 // mm      // 바닥에 편평도를 고려하여 조정   // 315.4

  // height from z=0 to home position
  #define DELTA_HEIGHT 298.6  // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  //#define DELTA_RADIUS 174.1 //mm  Get this value from auto calibrate
  #define DELTA_RADIUS 167.3 //mm  Get this value from auto calibrate       // 167.3
...
#define XYZ_FULL_STEPS_PER_ROTATION 160   //200
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 349.1 }  // default steps per unit for PowerWasp
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0.5  //0.3     // Z probe to nozzle Z offset: -below (always!)
